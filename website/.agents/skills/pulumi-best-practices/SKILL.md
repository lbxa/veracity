...
version: 1.0.0
description: Use when writing, reviewing, refactoring, or debugging Pulumi TypeScript or Python programs. Covers Output<T>, apply(), pulumi.interpolate, resource dependency order, parent/child relationships, aliases for no-destroy refactors, secrets, config, providers, preview correctness, and pulumi preview/up CI workflows. For deep ComponentResource authoring, also use `pulumi-component`.
---
