...
name: rust-skills
description: >
  Use when writing, reviewing, refactoring, debugging, testing, or optimizing
  Rust code, Cargo projects, crates, modules, public APIs, async code, or unsafe
  boundaries. Comprehensive Rust coding guidelines with 179 rules across 14
  categories covering ownership, borrowing, error handling, async patterns, API
  design, memory optimization, performance, testing, documentation, linting,
  naming, project structure, and common anti-patterns. Invoke with /rust-skills.
license: MIT
metadata:
  author: leonardomso
  version: "1.0.0"
