...
version: 1.0.0
description: Use when creating, refactoring, reviewing, or debugging Pulumi ComponentResource classes and reusable infrastructure components. Covers component args/interfaces, parent-child resource ownership, registerOutputs, component outputs, multi-language package support, component package distribution, and turning inline Pulumi resources into a reusable component.
---
