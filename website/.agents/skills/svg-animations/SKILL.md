---
name: svg-animations
description: Use when creating, editing, reviewing, or debugging SVG graphics, icons, illustrations, animated logos, path animations, morphing shapes, loading spinners, motion paths, masks, filters, gradients, or any animated SVG content. Covers handcrafted SVG markup, SMIL animation, CSS-driven SVG animation, path drawing effects, shape morphing, and performant vector animation.
---
